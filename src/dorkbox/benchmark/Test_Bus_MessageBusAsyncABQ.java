...
/**
 * this is a NON-default test when the disruptor is not available. This creates GARBAGE though, but it is faster than the no-gc version
 */
@SuppressWarnings("Duplicates")
public
class Test_Bus_MessageBusAsyncABQ {
    ...
    void main(final String[] args) throws Exception {
        ...
        MessageBus.useZeroGarbageVersionOfABQ = false;
        ...
        System.out.format("summary,%s, %,d\n", Test_Bus_MessageBusAsyncABQ.class.getSimpleName(), average);
    }
}
