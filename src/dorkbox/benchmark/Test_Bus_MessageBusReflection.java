...
// this is a NON-default test for when ASM is not available
@SuppressWarnings("Duplicates")
public
class Test_Bus_MessageBusReflection {
    ...
    void main(final String[] args) throws Exception {
        ...
        MessageBus.useAsmForDispatch = false;
        ...
        System.out.format("summary,%s, %,d\n", Test_Bus_MessageBusReflection.class.getSimpleName(), average);
    }
}
