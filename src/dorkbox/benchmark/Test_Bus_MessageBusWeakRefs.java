...
import dorkbox.benchmark.common.WeakListener;


@SuppressWarnings("Duplicates")
public
class Test_Bus_MessageBusWeakRefs {
    ...
    void main(final String[] args) throws Exception {
        ...
        WeakListener listener1 = new WeakListener();
        ...
        System.out.format("summary,%s, %,d\n", Test_Bus_MessageBusWeakRefs.class.getSimpleName(), average);
    }
}
